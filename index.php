...
<head>
  ...
  <!-- jquery cookies library cdn link -->
  ...
  <!-- custom js -->
  <script defer src="scripts/pagination.js"></script>
  <script defer src="scripts/image.js"></script>
...
<body>
  ...
  <div class="container">
    ...
    <!-- product table -->
    <?php include "components/productTable.html"; ?>
    
    <!-- modal forms -->
    <?php include "components/modalForm.html"; ?>
    <?php include "components/modalCard.html"; ?>
